...
{
    public partial class frm_grupo1 : DevExpress.XtraEditors.XtraForm
    {
        string id_usuario = Cls_Global.id_usuario;

        Cls_Grid_DevExpress_Mnt_1 Cls_Grid = new Cls_Grid_DevExpress_Mnt_1();
        List<EN_grupo1.t_grupo1> t_grupo1 = new List<EN_grupo1.t_grupo1>();
        DataTable dt_t_grupo1_grid = new DataTable();
        DataTable dt_t_grupo1_final = new DataTable();
        ...
        public frm_grupo1()
        {
            ...
            this.Load += new System.EventHandler(this.frm_grupo1_Load);
            this.Icon = Properties.Resources.empresa;
            this.Text = Cls_Global.empresa;
            this.MaximizeBox = false;
            labelControl1.Text = " grupo1s";
        ...
        private void frm_grupo1_Load(object sender, EventArgs e)
        {
        ...
        private void inicio()
        {
            dt_t_grupo1_grid = Cls_Grid.ListToTable(t_grupo1);
            dt_t_grupo1_final = Cls_Grid.ListToTable(t_grupo1);

            gridControl1.DataSource = dt_t_grupo1_grid;

            Cls_Grid.Load_Grid(gridControl1, gridView1, dt_t_grupo1_grid);
        ...
        private void mnt_datos(string id_usuario)
        {
            ...
            try
            {
                ...
                t_grupo1 = dt_t_grupo1_final.DataTableToList<EN_grupo1.t_grupo1>().ToList();
                var negocio = new LN_grupo1();
                var parametro = new EN_grupo1.proc_grupo1_mnt();
                var retorno = new EN_grupo1.proc_grupo1_mnt_retorno();

                parametro.id_usuario = id_usuario;
                parametro.t_grupo1 = t_grupo1;

                Cursor.Current = Cursors.WaitCursor;
                retorno = negocio.proc_grupo1_mnt(parametro);
                ...
                {
                    retorno.t_grupo1.ToList().ForEach(c => { c.id_usuario_inicia = ""; c.id_usuario_ultimo = "grabado"; });
                    dt_t_grupo1_grid = Cls_Grid.ListToTable(retorno.t_grupo1);
        ...
        private void gridControl1_EmbeddedNavigator_ButtonClick(object sender, NavigatorButtonClickEventArgs e)
        {
            ...
            {
                Cls_Grid.EmbeddedNavigator(gridView1, e, dt_t_grupo1_grid);
            }
            ...
            if (e.Button.ButtonType == NavigatorButtonType.EndEdit)
            {
                ...
                dt_t_grupo1_final = Cls_Grid.EmbeddedNavigator(gridView1, e, dt_t_grupo1_grid);

                int count = dt_t_grupo1_final.Rows.Count;
                if (count == 0)
                {
                    return;
                }
