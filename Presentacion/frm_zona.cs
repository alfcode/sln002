...
namespace Presentacion
{
    public partial class frm_zona : DevExpress.XtraEditors.XtraForm
    {
        ...
        List<EN_zona.t_zona> t_zona = new List<EN_zona.t_zona>();
        DataTable dt_t_zona_grid = new DataTable();
        DataTable dt_t_zona_final = new DataTable();
        ...
        public frm_zona()
        {
            ...
            labelControl1.Text = "Mantenimiento de zonas";
        ...
        private void inicio()
        {
            dt_t_zona_grid = Cls_Grid.ListToTable(t_zona);
            dt_t_zona_final = Cls_Grid.ListToTable(t_zona);

            gridControl1.DataSource = dt_t_zona_grid;
         
            Cls_Grid.Load_Grid(gridControl1, gridView1, dt_t_zona_grid);
        ...
        private void mnt_datos(string id_usuario)
        {
            ...
            try
            {
                ...
                t_zona = dt_t_zona_final.DataTableToList<EN_zona.t_zona>().ToList();
                var negocio = new LN_zona();
                var parametro = new EN_zona.proc_zona_mnt();
                var retorno = new EN_zona.proc_zona_mnt_retorno();

                parametro.id_usuario = id_usuario;
                parametro.t_zona = t_zona;

                Cursor.Current = Cursors.WaitCursor;
                retorno = negocio.proc_zona_mnt(parametro);
                ...
                {
                    retorno.t_zona.ToList().ForEach(c => { c.id_usuario_inicia = ""; c.id_usuario_ultimo = "grabado"; });
                    dt_t_zona_grid = Cls_Grid.ListToTable(retorno.t_zona);
        ...
        private void gridControl1_EmbeddedNavigator_ButtonClick(object sender, NavigatorButtonClickEventArgs e)
        {
            ...
            {
                Cls_Grid.EmbeddedNavigator(gridView1, e, dt_t_zona_grid);
            }
            ...
            if (e.Button.ButtonType == NavigatorButtonType.EndEdit)
            {
                ...
                dt_t_zona_final = Cls_Grid.EmbeddedNavigator(gridView1, e, dt_t_zona_grid);

                int count = dt_t_zona_final.Rows.Count;
                if (count == 0)
                {
                    return;
                }
