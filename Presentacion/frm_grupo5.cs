...
{
    public partial class frm_grupo5 : DevExpress.XtraEditors.XtraForm
    {
        string id_usuario = Cls_Global.id_usuario;

        Cls_Grid_DevExpress_Mnt_1 Cls_Grid = new Cls_Grid_DevExpress_Mnt_1();
        List<EN_grupo5.t_grupo5> t_grupo5 = new List<EN_grupo5.t_grupo5>();
        DataTable dt_t_grupo5_grid = new DataTable();
        DataTable dt_t_grupo5_final = new DataTable();
        ...
        public frm_grupo5()
        {
            ...
            this.Load += new System.EventHandler(this.frm_grupo5_Load);
        ...
        private void frm_grupo5_Load(object sender, EventArgs e)
        {
        ...
        private void inicio()
        {
            dt_t_grupo5_grid = Cls_Grid.ListToTable(t_grupo5);
            dt_t_grupo5_final = Cls_Grid.ListToTable(t_grupo5);

            gridControl1.DataSource = dt_t_grupo5_grid;

            Cls_Grid.Load_Grid(gridControl1, gridView1, dt_t_grupo5_grid);
        ...
        private void mnt_datos(string id_usuario)
        {
            ...
            try
            {
                ...
                t_grupo5 = dt_t_grupo5_final.DataTableToList<EN_grupo5.t_grupo5>().ToList();
                var negocio = new LN_grupo5();
                var parametro = new EN_grupo5.proc_grupo5_mnt();
                var retorno = new EN_grupo5.proc_grupo5_mnt_retorno();

                parametro.id_usuario = id_usuario;
                parametro.t_grupo5 = t_grupo5;

                Cursor.Current = Cursors.WaitCursor;
                retorno = negocio.proc_grupo5_mnt(parametro);
                ...
                {
                    retorno.t_grupo5.ToList().ForEach(c => { c.id_usuario_inicia = ""; c.id_usuario_ultimo = "grabado"; });
                    dt_t_grupo5_grid = Cls_Grid.ListToTable(retorno.t_grupo5);
        ...
        private void gridControl1_EmbeddedNavigator_ButtonClick(object sender, NavigatorButtonClickEventArgs e)
        {
            ...
            {
                Cls_Grid.EmbeddedNavigator(gridView1, e, dt_t_grupo5_grid);
            }
            ...
            if (e.Button.ButtonType == NavigatorButtonType.EndEdit)
            {
                ...
                dt_t_grupo5_final = Cls_Grid.EmbeddedNavigator(gridView1, e, dt_t_grupo5_grid);

                int count = dt_t_grupo5_final.Rows.Count;
                if (count == 0)
                {
                    return;
                }
