...
namespace Presentacion
{
    public partial class frm_salida : DevExpress.XtraEditors.XtraForm
    {
        ...
        List<EN_salida.t_salida_det> t_salida_det = new List<EN_salida.t_salida_det>();
        DataTable dt_t_salida_det_grid = new DataTable();
        DataTable dt_t_salida_det_final = new DataTable();

        List<EN_salida.lista_articulo> lista_articulo = new List<EN_salida.lista_articulo>();
        List<EN_salida.lista_tipo_unidad_almacen> lista_tipo_unidad_almacen = new List<EN_salida.lista_tipo_unidad_almacen>();

        List<EN_salida.lista_almacen> lista_almacen = new List<EN_salida.lista_almacen>();
        List<EN_salida.lista_tipo_salida> lista_tipo_salida = new List<EN_salida.lista_tipo_salida>();
        ...
        public frm_salida()
        {
            ...
            this.cbo_tipo_salida.EditValueChanged += new System.EventHandler(this.cbo_tipo_salida_EditValueChanged);
        ...
        private void inicio()
        {
            dt_t_salida_det_grid = Cls_Grid.ListToTable(t_salida_det);
            dt_t_salida_det_final = Cls_Grid.ListToTable(t_salida_det);
            ...
            Cls_Grid.Load_Grid(gridControl1, gridView1, dt_t_salida_det_grid);
        ...
        private void cargar_combo()
        {
            ...
            retorno = negocio.proc_salida_mnt_combo();
            ...
            Cls_Grid.Load_Combo_GridLookUpEdit_Simple(cbo_tipo_salida, retorno.tsalida, cbo_tipo_salida.Width, 300);
            ...
            lista_tipo_salida = retorno.tsalida;
        ...
        private void cargar_unidad_almacen(string id_almacen)
        {
            ...
            var parametros = new EN_salida.proc_salida_mnt_tipo_unidad_almacen_parametros();
            ...
            //{
            //    id_tipo_unidad_almacen_A = p.id_tipo_unidad_salida1;
            //    id_tipo_unidad_almacen_B = p.id_tipo_unidad_salida2;
            //}
        ...
        private void mnt_datos(string id_usuario)
        {
            ...
            try
            {
                ...
                t_salida_det = dt_t_salida_det_final.Tabla_a_Lista<EN_salida.t_salida_det>().ToList();

                var negocio = new LN_salida();
                var parametro = new EN_salida.proc_salida_mnt();
                var retorno = new EN_salida.proc_salida_mnt_retorno();
                var t_salida = new List<EN_salida.t_salida>();
                ...
                if (id_usuario != "")
                {
                    ...
                    var cab = new EN_salida.t_salida();
                    ...
                    cab.id_tsalida = cbo_tipo_salida.EditValue.ToString();
                ...
                parametro.t_salida_det = t_salida_det;

                Cursor.Current = Cursors.WaitCursor;
                retorno = negocio.proc_salida_mnt(parametro);
                Cursor.Current = Cursors.Default;
        ...
        private void gridControl1_EmbeddedNavigator_ButtonClick(object sender, NavigatorButtonClickEventArgs e)
        {
            ...
            if ("Folder".Equals(e.Button.Tag))
            {
                ...
                Cls_Grid.Visible_Columns(gridView1, dt_t_salida_det_grid);
            }
            ...
            if (e.Button.ButtonType == NavigatorButtonType.Remove)
            {
                ...
                Cls_Grid.EmbeddedNavigator(gridView1, e, dt_t_salida_det_grid);
                calculo_total();
            ...
            if (e.Button.ButtonType == NavigatorButtonType.EndEdit)
            {
                ...
                dt_t_salida_det_final = Cls_Grid.EmbeddedNavigator(gridView1, e, dt_t_salida_det_grid);


                if (modo == "nuevo")
                {
                    id_salida = "";
                    int count = dt_t_salida_det_final.Rows.Count;
                    if (count == 0)
                    {
        ...
        private bool valida_combo()
        {
            ...
            if (cbo_tipo_salida.EditValue == null || cbo_tipo_salida.Text == "")
            {
                DevExpress.XtraEditors.XtraMessageBox.Show("Seleccion el valor tipo de salida", Cls_Mensajes.titulo_ventana, MessageBoxButtons.OK, MessageBoxIcon.Exclamation, MessageBoxDefaultButton.Button1);
                return true;
            }
        ...
        private void habilitar()
        {
            ...
            if (modo == "nuevo")
            {
                dt_t_salida_det_grid.Clear();
                dt_t_salida_det_final.Clear();
        ...
        public async void calculo_total()
        {
            ...
            foreach (DataRow row in dt_t_salida_det_grid.Rows)
            {
        ...
        private void cbo_tipo_salida_EditValueChanged(object sender, EventArgs e)
        {
            if (cbo_tipo_salida.Enabled == true)
            {
