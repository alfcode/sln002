    ...
    public class DAO_departamento
    {
        ...
        public EN_departamento.proc_departamento_mnt_retorno proc_departamento_mnt(EN_departamento.proc_departamento_mnt parametros)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@tabla1", "rrhh.t_departamento");
                ...
                while (Result)
                {
                    ...
                    if (name == "t_departamento") dt = DAO_zero.estructura(dr, parametros.t_departamento);
                ...
                while (Result)
                {
                    ...
                    if (name == "t_departamento") retorno.t_departamento = dr.MapData<EN_departamento.t_departamento>().ToList();
                    Result = dr.NextResult();
                }
