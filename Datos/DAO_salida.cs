    ...
    public class DAO_salida
    {
        ...
        public EN_salida.proc_salida_mnt_combo proc_salida_mnt_combo()
        {
            ...
            try
            {
                ...
                cmd.Connection.Open();
                cmd.CommandText = "inve.proc_salida_mnt_combo";
                ...
                while (Result)
                {
                    ...
                    if (name == "t_almacen") retorno.almacen = dr.MapData<EN_salida.lista_almacen>().ToList();
                    ...
                    if (name == "t_tsalida") retorno.tsalida = dr.MapData<EN_salida.lista_tipo_salida>().ToList();
                    if (name == "t_moneda") retorno.moneda = dr.MapData<EN_zero.datacombo_simple>().ToList();
                    if (name == "t_articulo") retorno.lista_articulo = dr.MapData<EN_salida.lista_articulo>().ToList();
        ...
        public EN_salida.proc_salida_mnt_tipo_unidad_almacen proc_salida_mnt_tipo_unidad_almacen(EN_salida.proc_salida_mnt_tipo_unidad_almacen_parametros parametros)
        {
            ...
            try
            {
                cmd.Connection = AdoConn.Conn();
                cmd.Connection.Open();
                cmd.CommandText = "inve.proc_salida_mnt_tipo_unidad_almacen";
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                while (Result)
                {
                    var name = (dr.GetSchemaTable().Rows.Cast<DataRow>().Select(r => (string)r[0]).ToList()).First().ToString();
                    if (name == "informe") retorno.informe = dr.MapData<EN_zero.informe>().ToList();
                    if (name == "t_tipo_unidad_almacen") retorno.lista_tipo_unidad_almacen = dr.MapData<EN_salida.lista_tipo_unidad_almacen>().ToList();
                    if (name == "t_articulo") retorno.lista_articulo = dr.MapData<EN_salida.lista_articulo>().ToList();
        ...
        public EN_salida.proc_salida_mnt_busca_retorno proc_salida_mnt_busca(EN_salida.proc_salida_mnt_busca parametros)
        {
            ...
            try
            {
                cmd.Connection = AdoConn.Conn();
                cmd.Connection.Open();
                cmd.CommandText = "inve.proc_salida_mnt_busca";
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Clear();
                cmd.Parameters.AddWithValue("@id_almacen", parametros.id_almacen);
                ...
                while (Result)
                {
                    var name = (dr.GetSchemaTable().Rows.Cast<DataRow>().Select(r => (string)r[0]).ToList()).First().ToString();
                    if (name == "informe") retorno.informe = dr.MapData<EN_zero.informe>().ToList();
                    if (name == "t_salida_cab") retorno.t_salida_busca_cab = dr.MapData<EN_salida.t_salida_busca_cab>().ToList();
                    if (name == "t_salida_det") retorno.t_salida_busca_det = dr.MapData<EN_salida.t_salida_busca_det>().ToList();
                    if (name == "t_almacen") retorno.almacen = dr.MapData<EN_salida.lista_almacen>().ToList();
        ...
        public EN_salida.proc_salida_mnt_retorno proc_salida_mnt(EN_salida.proc_salida_mnt parametros)
        {
            ...
            try
            {
                ...
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Clear();
                cmd.Parameters.AddWithValue("@tabla1", "inve.t_salida");
                cmd.Parameters.AddWithValue("@tabla2", "inve.t_salida_det");
                dr = cmd.ExecuteReader();
                ...
                {
                    var name = (dr.GetSchemaTable().Rows.Cast<DataRow>().Select(r => (string)r[0]).ToList()).First().ToString();
                    if (name == "t_salida") dt = DAO_zero.estructura(dr, parametros.t_salida);
                    if (name == "t_salida_det") dt2 = DAO_zero.estructura(dr, parametros.t_salida_det);

                    Result = dr.NextResult();
                }
                dr.Close();

                cmd.CommandText = "inve.proc_salida_mnt";
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Clear();
                ...
                while (Result)
                {
                    var name = (dr.GetSchemaTable().Rows.Cast<DataRow>().Select(r => (string)r[0]).ToList()).First().ToString();
                    if (name == "informe") retorno.informe = dr.MapData<EN_zero.informe>().ToList();
                    if (name == "t_salida") retorno.t_salida = dr.MapData<EN_salida.t_salida>().ToList();
                    if (name == "t_salida_det") retorno.t_salida_det = dr.MapData<EN_salida.t_salida_det>().ToList();
