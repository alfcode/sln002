    ...
    public class DAO_grupo4
    {
        ...
        public EN_grupo4.proc_grupo4_mnt_retorno proc_grupo4_mnt(EN_grupo4.proc_grupo4_mnt parametros)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@tabla1", "inve.t_grupo4");
                ...
                while (Result)
                {
                    ...
                    if (name == "t_grupo4") dt = DAO_zero.estructura(dr, parametros.t_grupo4);
                ...
                while (Result)
                {
                    ...
                    if (name == "t_grupo4") retorno.t_grupo4 = dr.MapData<EN_grupo4.t_grupo4>().ToList();
                    Result = dr.NextResult();
                }
