    ...
    public class DAO_gironegocio
    {
        public EN_gironegocio.proc_gironegocio_mnt_retorno proc_gironegocio_mnt(EN_gironegocio.proc_gironegocio_mnt parametros)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@tabla1", "inve.t_gironegocio");
                ...
                while (Result)
                {
                    ...
                    if (name == "t_gironegocio") dt = DAO_zero.estructura(dr, parametros.t_gironegocio);
                ...
                while (Result)
                {
                    ...
                    if (name == "t_gironegocio") retorno.t_gironegocio = dr.MapData<EN_gironegocio.t_gironegocio>().ToList();
                    Result = dr.NextResult();
                }
