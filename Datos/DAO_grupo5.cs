    ...
    public class DAO_grupo5
    {
        ...
        public EN_grupo5.proc_grupo5_mnt_retorno proc_grupo5_mnt(EN_grupo5.proc_grupo5_mnt parametros)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@tabla1", "inve.t_grupo5");
                ...
                while (Result)
                {
                    ...
                    if (name == "t_grupo5") dt = DAO_zero.estructura(dr, parametros.t_grupo5);
                ...
                while (Result)
                {
                    ...
                    if (name == "t_grupo5") retorno.t_grupo5 = dr.MapData<EN_grupo5.t_grupo5>().ToList();
                    Result = dr.NextResult();
                }
