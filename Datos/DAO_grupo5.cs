        ...
        public EN_grupo5.proc_grupo5_mnt_retorno proc_grupo5_mnt(EN_grupo5.proc_grupo5_mnt parametros)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < ds.Tables.Count; i++)
                {
                    ...
                    if (name == "informe") { ds.Tables[i].TableName = "informe"; ds.Tables[i].Columns.RemoveAt(0); }
                    if (name == "grupo5") { ds.Tables[i].TableName = "grupo5"; ds.Tables[i].Columns.RemoveAt(0); }
                ...
                retorno.t_grupo5 = ds.Tables["grupo5"].DataTableToList<EN_grupo5.t_grupo5>().ToList();
