    ...
    public class DAO_moneda
    {
        public EN_moneda.proc_moneda_mnt_retorno proc_moneda_mnt(EN_moneda.proc_moneda_mnt parametros)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@tabla1", "conta.t_moneda");
                ...
                while (Result)
                {
                    ...
                    if (name == "t_moneda") dt = DAO_zero.estructura(dr, parametros.t_moneda);
                ...
                while (Result)
                {
                    ...
                    if (name == "t_moneda") retorno.t_moneda = dr.MapData<EN_moneda.t_moneda>().ToList();
                    Result = dr.NextResult();
                }
